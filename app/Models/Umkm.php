...
class Umkm extends Model
{
    ...
    protected $casts = [
        'latitude' => 'decimal:8',
        'longitude' => 'decimal:8',
        'depan_atas_w' => 'integer',
        'depan_atas_h' => 'integer',
        'depan_tengah_w' => 'integer',
        'depan_tengah_h' => 'integer',
        'depan_bawah_w' => 'integer',
        'depan_bawah_h' => 'integer',
        'kanan_atas_w' => 'integer',
        'kanan_atas_h' => 'integer',
        'kanan_tengah_w' => 'integer',
        'kanan_tengah_h' => 'integer',
        'kanan_bawah_w' => 'integer',
        'kanan_bawah_h' => 'integer',
        'kiri_atas_w' => 'integer',
        'kiri_atas_h' => 'integer',
        'kiri_tengah_w' => 'integer',
        'kiri_tengah_h' => 'integer',
        'kiri_bawah_w' => 'integer',
        'kiri_bawah_h' => 'integer',
